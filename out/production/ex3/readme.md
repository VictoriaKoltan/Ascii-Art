...
4. Introduced a public `RoundingMethod` enumeration to enhance communication between the interface and engine layers, allowing for clearer specification of rounding behavior.
